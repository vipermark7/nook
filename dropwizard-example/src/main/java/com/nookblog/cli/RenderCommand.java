package com.nookblog.cli;

import com.nookblog.NookConfiguration;
...
public class RenderCommand extends ConfiguredCommand<NookConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<NookConfiguration> bootstrap,
                       Namespace namespace,
                       NookConfiguration configuration) throws Exception {
